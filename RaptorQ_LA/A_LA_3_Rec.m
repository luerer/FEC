function RecIntermediateSymbols = A_LA_3_Rec(B,E1,E2,RecISIs_B,RecISIs_E1,RecISIs_E2,RecSymbols_B,RecSymbols_E1,RecSymbols_E2)
...
RecIntermediateSymbols(length(RecInt_B)+1:length(RecInt_B)+length(RecInt_E1)) = temp1(:).';
RecIntermediateSymbols(length(RecInt_B)+length(RecInt_E1)+1:end) = temp2(:).';
